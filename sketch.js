...
function draw() {
  ...
  text("RULES: 1) Reach the door to win,  2) Use the arrow keys to move , 3) Up arrow key to jump, left arrow key to go back and the right arrow key to move forward");
  fill("white");
